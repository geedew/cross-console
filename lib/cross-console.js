...
;(function(win,undefined) {
	...
	handleCircularReferences = function() {
		var circularKeys = []; // resetting the brains
	...
	updateHistory = function(msg) {
		...
		if( persist ) {
			root.localStorage.setItem(CC.settings.persistConfig.history,root.JSON.stringify( CC.settings.history, handleCircularReferences(), ""));
		}
	},
